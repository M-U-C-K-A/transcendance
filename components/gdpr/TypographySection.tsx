// components/TypographySection.tsx
export function TypographySection() {
  return (
    <div className="prose prose-sm dark:prose-invert pr-4 max-w-none overflow-y-scroll max-h-[400px]">
          <h1 className="scroll-m-20 text-center text-4xl font-extrabold tracking-tight text-balance">Privacy Policy</h1>
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Application</strong> refers to PongMaster, the software program provided by the Company.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Company</strong> (referred to as either &quot;the Company&quot;, &quot;We&quot;, &quot;Us&quot; or &quot;Our&quot; in this Agreement) refers to 42 school student, 20 Quai Frissard, 76600 Le Havre.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Country</strong> refers to:  France</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Service</strong> refers to the Application or the Website or both.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Website</strong> refers to PongMaster, accessible from <a href="https://c2r8p5.42lehavre.fr:8443/en/gdpr" rel="external nofollow noopener" target="_blank">https://c2r8p5.42lehavre.fr:8443/en/gdpr</a></p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Necessary / Essential Cookies</strong></p>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>Cookies Policy / Notice Acceptance Cookies</strong></p>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>To provide and maintain our Service</strong>, including to monitor the usage of our Service.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>To manage Your Account:</strong> to manage Your registration as a user of the Service. The Personal Data You provide can give You access to different functionalities of the Service that are available to You as a registered user.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>For the performance of a contract:</strong> the development, compliance and undertaking of the purchase contract for the products, items or services You have purchased or of any other contract with Us through the Service.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>To provide You</strong> with news, special offers and general information about other goods, services and events which we offer that are similar to those that you have already purchased or enquired about unless You have opted not to receive such information.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
<strong>To manage Your requests:</strong> To attend and manage Your requests to Us.</p>
</li>
<li>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
Delete Your Personal Data</h3>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
You have the right to delete or request that We assist in deleting the Personal Data that We have collected about You.</p>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
...
Please note, however, that We may need to retain certain information when we have a legal obligation or lawful basis to do so.</p>
    <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
Disclosure of Your Personal Data</h3>
    <h4 className="scroll-m-20 text-xl font-semibold tracking-tight">
...
<li>Protect against legal liability</li>
    ...
    <h3 className="scroll-m-20 text-2xl font-semibold tracking-tight">
Security of Your Personal Data</h3>
    <p className="leading-7 [&:not(:first-child)]:mt-6">
