...
const initialMessages: Message[] = [
  ...
  {
    id: 2,
    user: { name: "Bob", avatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=Bob" },
    text: "Je suis disponible pour un match rapide !",
    timestamp: new Date(Date.now() - 1000 * 60 * 10),
  },
  {
    id: 3,
    user: { name: "Charlie", avatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=Charlie" },
    text: "Je viens de terminer un tournoi, c'était intéressant.",
    timestamp: new Date(Date.now() - 1000 * 60 * 5),
  },
  {
    id: 4,
    user: { name: "David", avatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=David" },
...
export function ChatComponent({ placeholder = "Écrivez un message..." }: ChatComponentProps) {
  ...
  const handleSendMessage = (e: React.FormEvent) => {
    ...
    const message: Message = {
      ...
      user: { name: "John Doe", avatar: "https://api.dicebear.com/9.x/bottts-neutral/svg?seed=Alice" },
      text: newMessage,
      timestamp: new Date(),
    }
