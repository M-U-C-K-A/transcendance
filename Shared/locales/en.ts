export default {
	...
	"zod": {
		"password": {
			...
			"tooLong": "Password cannot be longer than 30 characters.",
			"needLowercase": "Password must contain at least one lowercase letter.",
			"needUppercase": "Password must contain at least one uppercase letter.",
			"needNumber": "Password must contain at least one number.",
			"needSpecialChar": "Password must contain at least one special character."
		},
		"email": {
			"invalid": "Email is not valid.",
			"tooShort": "Email must be at least 5 characters long.",
			"tooLong": "Email cannot be longer than 100 characters."
		},
		"code": {
			"invalid": "The verification code is invalid. It must be 6 characters long."
		},
		"username": {
			"tooShort": "Username must be at least 3 characters long.",
			"tooLong": "Username cannot be longer than 20 characters.",
			"invalidChar": "Username can only contain letters, numbers, and underscores."
		}
	}
}
