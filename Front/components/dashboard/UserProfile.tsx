  ...
  return (
    <Card className="bg-card border shadow-sm">
      ...
      <CardContent className="flex flex-col items-center">
        ...
        {user.bio && <p className="text-sm text-center text-muted-foreground mb-4">{user.bio}</p>}
        <div className="grid grid-cols-3 w-full gap-4 text-center mb-4">
          <div>
            <h3 className="text-2xl font-bold text-primary">{user.win}</h3>
            <p className="text-xs text-muted-foreground">{t('Profile.stats.wins')}</p>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-red-400">{user.lose}</h3>
            <p className="text-xs text-muted-foreground">{t('Profile.stats.losses')}</p>
          </div>
          <div>
            <h3 className="text-2xl font-bold text-yellow-400">{user.tournamentWon}</h3>
